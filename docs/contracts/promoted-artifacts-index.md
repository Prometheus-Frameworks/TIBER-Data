...
| [`exports/promoted/identity_crosswalk/tiber_identity_crosswalk_v2.json`](../../exports/promoted/identity_crosswalk/tiber_identity_crosswalk_v2.json) | Operator-promoted GSIS-vocabulary slice; explicitly not full player-universe coverage; not interchangeable with the v1 identifier vocabulary | `v2` | Not seasonal; 68 `sleeper` mappings: 23 `gsis_direct`, 6 `espn_bridge`, 39 `name_exact` | TIBER-Data | Artifact fields/source-artifact digests; promotion PR #244 |
