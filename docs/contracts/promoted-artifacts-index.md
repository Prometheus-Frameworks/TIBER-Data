...
Inventory basis: committed artifacts in this revision, updated 2026-09-09 for
PR #266's four-row Draft Review admission extension to the identity-crosswalk
v2 slice promoted by PR #244.
...
| [`exports/promoted/identity_crosswalk/tiber_identity_crosswalk_v2.json`](../../exports/promoted/identity_crosswalk/tiber_identity_crosswalk_v2.json) | Operator-promoted GSIS-vocabulary slice with four operator-accepted `name_exact`/medium Draft Review additions; explicitly not full player-universe coverage; not interchangeable with the v1 identifier vocabulary | `v2` | Not seasonal; 72 `sleeper` mappings: 23 `gsis_direct`, 6 `espn_bridge`, 43 `name_exact` | TIBER-Data | Artifact fields/source-artifact digests; promotion PR #244; [four-row admission receipt](../../exports/promoted/draft_review/evidence_admission_v1.json) |
