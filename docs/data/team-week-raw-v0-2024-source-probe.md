...
| `secondsPerPlay` | `requires_play_by_play` | play-by-play game clock / elapsed time | Compute elapsed offensive seconds divided by included plays. | Clock handling, period boundaries, and no-play treatment are unresolved. |
