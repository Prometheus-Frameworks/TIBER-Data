...
- **Shape:** QASports2 — 2,183,926 rows across 21 sport subsets (incl. American Football), Parquet, 310 MB, train/validation/test splits. QASports v1 — ~1.55M rows, 2.23 GB, CSV+Parquet, three sports (american football 704k, soccer 614k, basketball 232k); paper at Brazilian Symposium on Databases 2023; full data also on OSF.
